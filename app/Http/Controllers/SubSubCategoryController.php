...
class SubSubCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $subsubcategories = $subsubcategories->get();
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('icon')){
            $subsubcategory->icon = $request->file('icon')->store('uploads/subsubcategory/icon');
        }
    ...
    public function edit($id)
    {
        ...
        $categories = Category::all();
        $brands = Brand::all();
        return view('subsubcategories.edit', compact('subsubcategory', 'categories', 'brands','subcategory'));
    }
