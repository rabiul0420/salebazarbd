                    ...
                    <div class="card mb-3" id="cart-details">
                        <div class="card-body">
                            <div class="pos-cart c-scrollbar">
                                <table class="table table-bordered mb-0 mar-no table-responsive" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                        ...
                        <div class="card-footer bord-top">
                            <table class="table mb-0 mar-no table-responsive" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
