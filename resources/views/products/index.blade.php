...
<div class="panel">
    ...
    <div class="panel-heading bord-btm clearfix pad-all h-100">
        ...
        <div class="pull-right clearfix">
            <form class="" id="sort_products" action="" method="GET">
                ...
                <div class="box-inline pad-rgt pull-left">
                    <div class="select" style="min-width: 100px;">
                        <select class="form-control demo-select2" name="filter" id="filter" onchange="filterProducts()">
                            <option value="">Filter Products</option>
                            <option value="1" @isset($filter) @if($filter == 1) selected @endif @endisset>Approved</option>
                            <option value="0" @isset($filter) @if($filter == 0) selected @endif @endisset>Not Approved</option>
                        </select>
                    </div>
                </div>
                <div class="box-inline pad-rgt pull-left">
    ...
    <div class="panel-body">
        <table class="table mar-no" id="product_table" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th>#</th>
            ...
            <tbody>
                @foreach($products as $key => $product)
                    <tr>
                        ...
                        <td>
                            <label class="switch">
                                <input onchange="approveProduct(this)" value="{{ $product->id }}" type="checkbox" <?php if($product->is_approved == 1) echo "checked";?> >
...
@section('script')
    <script type="text/javascript">
        ...
        function approveProduct(id){
            ...
            $.post('{{ route('products.approved') }}', {_token:'{{ csrf_token() }}', id:id.value, is_approved:is_approved}, function(data){
                if(data == 1) {
                    showAlert('success', 'Approved status updated successfully');
                } else {
                    showAlert('danger', 'Something went wrong');
                }
            });
