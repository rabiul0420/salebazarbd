			...
			<div class="panel">
				...
				<div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <input type="number" min="0" step="0.01" required placeholder="{{__('Wholesale price')}}" name="wholesale_price" class="form-control" value="{{$product->wholesale_price}}" required>
                        </div>
                    </div>
                    <div class="form-group">
			...
			@if (\App\BusinessSetting::where('type', 'shipping_type')->first()->value == 'product_wise_shipping')
    			...
    			<div class="panel">
    				...
    				<div class="panel-body">
    					<div class="form-group">
    						<div class="col-lg-2">
        						<label class="col-lg-2 control-label">{{__('Free Shipping')}}</label>
    						</div>
    						<div class="col-lg-7">
    					...
    					<div class="form-group">
    						<div class="col-lg-2">
        						<label class="col-lg-2 control-label">{{__('Flat Rate')}}</label>
    						</div>
    						<div class="col-lg-7">
    						     <input type="number" min="0" step="0.01"
                        ...
                        <div class="form-group">
    						<div class="col-lg-2">
        						<label class="col-lg-2 control-label">{{__('Same Upazilla/Thana/PS charge')}}</label>
    						</div>
    						<div class="col-lg-7">
    					...
    					<div class="form-group">
    						<div class="col-lg-2">
        						<label class="col-lg-2 control-label">{{__('Same City charge')}}</label>
    						</div>
    						<div class="col-lg-7">
    						     <input type="number" min="0"
    					...
    					<div class="form-group">
    						<div class="col-lg-2">
        						<label class="col-lg-2 control-label">{{__('Same District charge')}}</label>
    						</div>
    						<div class="col-lg-7">
    						     <input type="number" min="0"
    					...
    					<div class="form-group">
    						<div class="col-lg-2">
        						<label class="col-lg-2 control-label">{{__('Same Division charge')}}</label>
    						</div>
    						<div class="col-lg-7">
    						     <input type="number" min="0"
    					...
    					<div class="form-group">
    						<div class="col-lg-2">
        						<label class="col-lg-2 control-label">{{__('Same Country charge')}}</label>
    						</div>
    						<div class="col-lg-7">
    						     <input type="number" min="0"
