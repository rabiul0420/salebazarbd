    	...
    	<div class="panel-body">
    		<div class="invoice-masthead">
    			<div class="invoice-text">
    				<h3 class="h1 text-thin mar-no text-primary">{{ __('Order Edit') }}</h3>
    			</div>
    		</div>
            <div class="row">
                @php
                            ...
                            @foreach ($order->orderDetails->where('seller_id', $admin_user_id) as $key => $orderDetail)
                                <tr>
                					...
                					<td class="text-center">
                					    <input type="number" class="form-control" value="{{ $orderDetail->quantity }}">
                						
                					</td>
                					<td class="text-center">
                					    <input type="number" class="form-control" value="{{ $orderDetail->price }}">
                						
                					</td>
                                    <td class="text-center">
                                        <input type="text" class="form-control" value="{{ single_price($orderDetail->price) }}">
