                                ...
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a
                                                    href="{{ route('seller.products.upload') }}">{{ __('Add New Product') }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3 tagsInput" name="tags[]"
                                                placeholder="Type & hit enter" data-role="tagsinput" required>
                                        </div>
                                    </div>
                                    @php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" value="0" step="0.01"
                                                ...
                                                placeholder="{{ __('Unit Price') }} ({{ __('Base Price') }})" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" value="0" step="0.01"
                                                ...
                                                placeholder="{{ __('Purchase Price') }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                ...
                                <div class="form-box bg-white mt-4">
                                    ...
                                    <div class="form-box-content p-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="number" min="0" value="0" step="0.01"
                                                    class="form-control mb-3" name="sutp"
