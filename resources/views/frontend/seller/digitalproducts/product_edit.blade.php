                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <h2 class="heading heading-6 text-capitalize strong-600 mb-0">
                                        {{__('Update your Digital product')}}
                                    </h2>
                                </div>
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="{{ route('seller.digitalproducts.edit', $product->id) }}">{{__('Edit Digital Product')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="" action="{{route('digitalproducts.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-2">
                                            <label>{{__('Product File')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
