                                ...
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a
                                                    href="{{ route('seller.products.edit', $product->id) }}">{{ __('Edit Product') }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <form class="" action="{{ route('products.update', $product->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="name"
                                                placeholder="{{ __('Product Name') }}" value="{{ __($product->name) }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ __('Product Category') }} <span
                                                    class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            @if ($product->subsubcategory != null)
                                                <div class="form-control mb-3 c-pointer" data-toggle="modal"
                                                    data-target="#categorySelectModal" id="product_category">
                                            ...
                                            <input type="hidden" name="subcategory_id" id="subcategory_id"
                                                value="{{ $product->subcategory_id }}" required>
                                            <input type="hidden" name="subsubcategory_id" id="subsubcategory_id"
                                                value="{{ $product->subsubcategory_id }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                <select class="form-control mb-3 selectpicker"
                                                    data-placeholder="Select a brand" id="brands" name="brand_id">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3 tagsInput" name="tags[]"
                                                placeholder="Type & hit enter" data-role="tagsinput"
                                                value="{{ $product->tags }}">
                                        </div>
                                    </div>
                                    @php
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ __('Thumbnail Image') }} <small>(290x300)</small> <span
                                                    class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <input type="file" name="featured_img" id="file-3"
                                                class="custom-input-file custom-input-file--4"
                                                data-multiple-caption="{count} files selected" accept="image/*" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                @if ($product->flash_deal_img != null)
                                                    <div class="col-md-3">
                                                        <div class="img-upload-preview">
                                                            <img loading="lazy"
                                                                src="{{ asset($product->flash_deal_img) }}"
                                                                alt="" class="img-responsive">
                                            ...
                                            <input type="file" name="flash_deal_img" id="file-4"
                                                class="custom-input-file custom-input-file--4"
                                                data-multiple-caption="{count} files selected" accept="image/*" />
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="meta_title"
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                @if ($product->meta_img != null)
                                                    <div class="col-md-3">
                                                        <div class="img-upload-preview">
                                                            <img loading="lazy" src="{{ asset($product->meta_img) }}"
                                                                alt="" class="img-responsive">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-4 col-xl-1 col-md-2 order-2 order-md-0 text-right">
                                                    <button type="button" onclick="delete_row(this)"
                                                        class="btn btn-link btn-icon text-danger"><i
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" step="0.01"
                                                class="form-control mb-3" name="unit_price"
                                                placeholder="{{ __('Unit Price') }} ({{ __('Base Price') }})"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" step="0.01"
                                                class="form-control mb-3" name="purchase_price"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <input type="number" min="0" step="0.01"
                                                class="form-control mb-3" name="tax"
                                                placeholder="{{ __('Tax') }}" value="{{ $product->tax }}">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <input type="number" min="0" step="0.01"
                                                class="form-control mb-3" name="discount"
                                    ...
                                    <div class="row" id="quantity">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" step="1"
                                                class="form-control mb-3" name="current_stock"
                                ...
                                <div class="form-box bg-white mt-4">
                                    ...
                                    <div class="form-box-content p-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="number" min="0" step="0.01"
                                                    class="form-control mb-3" name="free_shipping_cost" value="0"
                                                    disabled placeholder="{{ __('Flat Rate Cost') }}">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="switch" style="margin-top:5px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="number" min="0" step="0.01"
                                                    class="form-control mb-3" name="flat_shipping_cost"
                                                    value="{{ $product->shipping_cost }}"
                                                    placeholder="{{ __('Flat Rate Cost') }}">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="switch" style="margin-top:5px;">
                                    ...
                                    <div class="form-box-content p-3">
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label>{{ __('Same Upazilla/Thana/PS charge') }} <span
                                                        class="required-star">*</span></label>
                                            </div>
                                            <div class="col-md-8">
                                                <input type="number" min="0"
                                                    value="{{ $shipping_charges->sutp ?? 0 }}" step="0.01"
                                                    class="form-control mb-3" name="sutp" value=""
                                                    placeholder="{{ __('Same Upazilla/Thana/PS') }}" required>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="switch" style="margin-top:5px;">
                                                    <input type="radio" name="shipping_type" value="dynamic"
                                                        @if ($product->shipping_type == 'dynamic') checked @endif>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label>{{ __('Same City charge') }} <span
                                                        class="required-star">*</span></label>
                                            </div>
                                            <div class="col-md-8">
                                                <input type="number" min="0"
                                                    value="{{ $shipping_charges->scity ?? 0 }}" step="0.01"
                                                    class="form-control mb-3" name="scity"
                                                    placeholder="{{ __('Same City') }}" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label>{{ __('Same District charge') }} <span
                                                        class="required-star">*</span></label>
                                            </div>
                                            <div class="col-md-8">
                                                <input type="number" min="0"
                                                    value="{{ $shipping_charges->sdistrict ?? 0 }}" step="0.01"
                                                    class="form-control mb-3" name="sdistrict"
                                                    placeholder="{{ __('Same District') }}" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label>{{ __('Same Division charge') }} <span
                                                        class="required-star">*</span></label>
                                            </div>
                                            <div class="col-md-8">
                                                <input type="number" min="0"
                                                    value="{{ $shipping_charges->sdivision ?? 0 }}" step="0.01"
                                                    class="form-control mb-3" name="sdivision"
                                                    placeholder="{{ __('Same Division') }}" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label>{{ __('Same Country charge') }} <span
                                                        class="required-star">*</span></label>
                                            </div>
                                            <div class="col-md-8">
                                                <input type="number" min="0"
                                                    value="{{ $shipping_charges->scountry ?? 0 }}" step="0.01"
                                                    class="form-control mb-3" name="scountry"
                                                    placeholder="{{ __('Same Country') }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" value="{{ $shipping_charges->sutp }}"
                                                step="0.01" class="form-control mb-3" name="sutp" value=""
                                                placeholder="{{ __('Same Upazilla/Thana/PS') }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" value="{{ $shipping_charges->scity }}" step="0.01"
                                                class="form-control mb-3" name="scity"
                                                placeholder="{{ __('Same City') }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" value="{{ $shipping_charges->sdistrict }}" step="0.01"
                                                class="form-control mb-3" name="sdistrict"
                                                placeholder="{{ __('Same District') }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" value="{{ $shipping_charges->sdivision }}" step="0.01"
                                                class="form-control mb-3" name="sdivision"
                                                placeholder="{{ __('Same Division') }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" value="{{ $shipping_charges->scountry }}" step="0.01"
                                                class="form-control mb-3" name="scountry"
                                                placeholder="{{ __('Same Country') }}" required>
                                        </div>
                                    </div>
                            ...
                            <div class="form-box mt-4 text-right">
                                <button type="submit"
                                    class="btn btn-styled btn-base-1">{{ __('Update This Product') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="overflow-x: scroll;">
                    ...
                    <div class="row no-gutters modal-categories mt-4 mb-2" style="min-width:630px;">
                        <div class="col-4">
                                ...
                                <div class="modal-category-list has-right-arrow">
                                    <ul id="categories">
                                        @foreach ($categories as $key => $category)
                                            <li onclick="get_subcategories_by_category(this, {{ $category->id }})">
                                                {{ __($category->name) }}</li>
                                        @endforeach
                                    </ul>
                                </div>
    ...
    <script type="text/javascript">
        ...
        function get_subcategories_by_category(el, cat_id) {
            ...
            $.post('{{ route('subcategories.get_subcategories_by_category') }}', {
                ...
                for (var i = 0; i < data.length; i++) {
                    $('#subcategories').append('<li onclick="get_subsubcategories_by_subcategory(this, ' + data[i]
                        .id + ')">' + data[i].name + '</li>');
                }
        ...
        function get_subsubcategories_by_subcategory(el, subcat_id) {
            ...
            $.post('{{ route('subsubcategories.get_subsubcategories_by_subcategory') }}', {
                ...
                for (var i = 0; i < data.length; i++) {
                    $('#subsubcategories').append('<li onclick="confirm_subsubcategory(this, ' + data[i].id +
                        ')">' + data[i].name + '</li>');
                }
        ...
        function add_more_customer_choice_option(i, name) {
            ...
            $('#customer_choice_options').append(
                '<div class="row mb-3"><div class="col-8 col-md-3 order-1 order-md-0"><input type="hidden" name="choice_no[]" value="' +
                i + '"><input type="text" class="form-control" name="choice[]" value="' + name +
                '" placeholder="Choice Title" readonly></div><div class="col-12 col-md-7 col-xl-8 order-3 order-md-0 mt-2 mt-md-0"><input type="text" class="form-control tagsInput" name="choice_options_' +
                i +
                '[]" placeholder="Enter choice values" onchange="update_sku()"></div><div class="col-4 col-xl-1 col-md-2 order-2 order-md-0 text-right"><button type="button" onclick="delete_row(this)" class="btn btn-link btn-icon text-danger"><i class="fa fa-trash-o"></i></button></div></div>'
            );
        ...
        function add_more_slider_image() {
            ...
            photoAdd += '<input type="file" name="photos[]" id="photos-' + photo_id +
