...
@section('meta_title'){{ $detailedProduct->name ?? "Product Detail" }}@stop
                        ...
                        <div class="product-description-wrapper">
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-sm-10 col-8">
                                        <div class="product-quantity row align-items-center">
                                            <div class="input-group input-group--style-2 pr-3 col-sm-6 col-12" style="width: 160px;">
                                            ...
                                            <div class="col-sm-6 col-12 mt-2 avialable-amount">(<span id="available-quantity">{{ $qty }}</span> {{__('available')}})</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-table width-100 mt-3">
                                <div style="display:flex;justify-content:space-around;flex-wrap:wrap;">
                                    <!-- Buy Now button -->
                                    @if ($qty > 0)
                                        <button type="button" class="btn btn-styled btn-base-1 btn-icon-left strong-700 hov-bounce hov-shaddow buy-now mt-2" onclick="buyNow()">
                                            <i class="la la-shopping-cart"></i> {{__('Buy Now')}}
                                        </button>
                                        <button type="button" class="btn btn-styled btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow mt-2 add-to-cart" onclick="addToCart()">
                        ...
                        <div class="products-box-bar p-1 bg-white rep">
                            <div class="row sm-no-gutters gutters-5 infinite-scroll">
                                ...
                                {{-- @foreach ($products as $key => $product) --}}
                                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-6 p-0">

                                        <div class="product-box-2 bg-white alt-box my-md-2 product-hover mr-lg-1 ml-lg-1 ml-0 mr-0" style="">
                                            <div class="position-relative overflow-hidden">
                                                <a href="{{ route('product', $related_product->slug) }}" class="d-block product-image h-100 text-center mobile-view-img" tabindex="0">
                                                    <img style="width:100%;max-height:220px;" class="img-fit lazyload" src="{{ asset('frontend/images/placeholder.jpg') }}" data-src="{{ asset($related_product->featured_img ?? $related_product->featured_img) }}" alt="{{ __($related_product->name) }}">
                                                </a>
            ...
            <div class="modal-content position-relative">
                ...
                <form class="" action="{{ route('conversations.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body gry-bg px-3 pt-3">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="5" name="message" required placeholder="Your Question">{{ route('product', $detailedProduct->slug) }}</textarea>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="login_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-zoom" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">{{__('Login to your account.')}}</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                                ...
                                <div class="px-2 py-3">
                                    <form class="form-default" role="form" action="{{ route('cart.login.submit') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 col-sm-6 text-right mb-2">
