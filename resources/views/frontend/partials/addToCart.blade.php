            ...
            <div class="product-description-wrapper">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-sm-10 col-8">
                                <div class="product-quantity row align-items-center">
                                    ...
                                    <div class="col-sm-6 col-12 avialable-amount mt-2">(<span
                ...
                <div class="d-table width-100 mt-3">
                    <div style="display:flex;justify-content:space-around;flex-wrap:wrap;">
                        ...
                        @if ($product->digital == 1)
                            <button type="button"
                                    class="btn btn-styled btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow mt-2 add-to-cart"
                                    onclick="addToCart()">
                        ...
                        @else
                            <button type="button" class="btn btn-styled btn-base-3 btn-icon-left strong-700 mt-2" disabled>
