...
<section class="slice-sm footer-top-bar bg-white d-lg-block">
...
<footer id="footer" class="footer">
    <div class="footer-top d-lg-block">
        <div class="container">
                ...
                <div class="col-lg-5 col-xl-4 text-center text-md-left">
                    <div class="col">
                        ...
                        <div class="d-inline-block d-md-block">
                            <form class="form-inline" method="POST" action="{{ route('subscribers.store') }}" style="justify-content:space-around;">
                                @csrf
                                <div class="form-group mb-0">
                                    <input type="email" class="form-control" placeholder="{{__('Your Email Address')}}" name="email" required style="margin-top:10px;">
                                </div>
                                <button type="submit" class="btn btn-base-1 btn-icon-left" style="margin-top:10px;">
                                    {{__('Subscribe')}}
                                </button>
                            </form>
                        </div>
    ...
    <div class="footer-bottom py-3 sct-color-3">
        ...
        <div style="text-align: center;margin: 13px 0;">
            <img loading="lazy" style="max-width:100%;" src="https://salebazarbd.com/frontend/images/pay.png">
        ...
        <div class="container">
            <div class="row row-cols-xs-spaced flex flex-items-xs-middle">
                ...
                <div class="col-md-4">
                    <ul class="text-center my-3 my-md-0 social-nav model-2">
                        ...
                        @if ($generalsetting->linkedin != null)
                            <li>
                                <a href="{{ $generalsetting->linkedin }}" class="linkedin" target="_blank" data-toggle="tooltip" data-original-title="Linkedin">
                ...
                <div class="col-md-4">
                    <div class="text-center text-md-right payment_methods">
