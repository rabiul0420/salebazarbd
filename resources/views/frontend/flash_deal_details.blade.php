                    ...
                    @foreach ($flash_deal->flash_deal_products as $key => $flash_deal_product)
                        ...
                        @if ($product->published != 0)
                            <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                                <div class="product-card-2 flash-detail-card card card-product shop-cards shop-tech mb-2">
                                ...
                                <input type="hidden" name="id" value="{{ $product->id }}">
                                        <button type="button" class="btn btn-styled btn-flash btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2 add-to-cart" onclick="addToListCart({{ $product->id }})">
