    ...
    <div class="panel-body">
        <div class="">
            ...
            <div class="text-center">
                <div class="pad-ver">
                    <img src="{{ asset($seller->user->avatar_original) ? asset($seller->user->shop->logo) : asset('frontend/images/placeholder.jpg') }}"
                ...
                <div class="pad-ver btn-groups">
                    <label>Hide Banner on Shop Page</label><br>
                    <label class="mt-1 switch">
                        <input onchange="hide_banner(this)" value="{{ $seller->user->shop->id }}"
                            type="checkbox" <?php if($seller->user->shop->is_banner_hidden == 1) echo "checked";?> >
