...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center">{{__('aamarPay Credential')}}</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="AAMARPAY_MERCHANT_ID">
                        <div class="col-lg-3">
                            <label class="control-label">{{__('MERCHANT ID')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="AAMARPAY_MERCHANT_ID" value="{{  env('AAMARPAY_MERCHANT_ID') }}" placeholder="MERCHANT ID" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="AAMARPAY_SIGNATURE_KEY">
                        <div class="col-lg-3">
                            <label class="control-label">{{__('SIGNATURE KEY')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="AAMARPAY_SIGNATURE_KEY" value="{{  env('AAMARPAY_SIGNATURE_KEY') }}" placeholder="SIGNATURE KEY" required>
                        </div>
                    </div>
