...
<nav id="mainnav-container">
 ...
 <li class="{{ areActiveRoutes(['notice.index'])}}">
                            <a class="nav-link" href="{{route('notice.index')}}">
                                 <i class="fa fa-bell-o" ></i> 
                                <span class="menu-title">{{__('Notice')}}</span>
                            </a>
                        </li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ areActiveRoutes(['reseller_deals.store', 'reseller_deals.create', 'reseller_deals.index'])}}">
                                        <a class="nav-link" href="{{route('reseller_deals.index')}}">{{__('Whole Sale Products')}}</a>
                                    </li>
                        ...
                        <li class="{{ areActiveRoutes(['orders.cancelled'])}}">
                            <a class="nav-link" href="{{ route('orders.cancelled') }}">
                                <i class="fa fa-close"></i>
                                <span class="menu-title">{{__('Cancelled Orders')}}</span>
                            </a>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                <li class="{{ areActiveRoutes(['sellers.index', 'sellers.create', 'sellers.edit', 'sellers.payment_history','sellers.approved','sellers.profile_modal'])}}">
                                    ...
                                    @endphp
                                    <a class="nav-link" href="{{route('sellers.index')}}">{{__('ReSeller List')}} @if($sellers > 0)<span class="pull-right badge badge-info">{{ $sellers }}</span> @endif</a>
                                </li>
                                <li class="{{ areActiveRoutes(['withdraw_requests_all'])}}">
                                    <a class="nav-link" href="{{ route('withdraw_requests_all') }}">{{__('ReSeller Withdraw Requests')}}</a>
                                </li>
                                ...
                                <li class="{{ areActiveRoutes(['sellers.payment_histories'])}}">
                                    <a class="nav-link" href="{{ route('sellers.payment_histories') }}">{{__('ReSeller Payments')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['business_settings.vendor_commission'])}}">
                                    <a class="nav-link" href="{{ route('business_settings.vendor_commission') }}">{{__('ReSeller Commission')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['seller_verification_form.index'])}}">
                                    <a class="nav-link" href="{{route('seller_verification_form.index')}}">{{__('ReSeller Verification Form')}}</a>
                                </li>
                        ...
                        @endif
                        @php
                            $conversation = \App\Conversation::where('receiver_viewed', '1')->get();
                        @endphp
