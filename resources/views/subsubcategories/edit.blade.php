                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name="sub_category_id" id="sub_category_id" class="form-control demo-select2" required>
                            <option value="{{ $subcategory->id ?? ''}}" selected="selected"> {{ $subcategory->name ?? 'Select one'}}</option>

                        </select>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="icon">{{__('Icon')}} <small>(64*64)</small></label>
                    <div class="col-sm-9">
