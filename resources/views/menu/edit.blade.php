...
<div class="col-lg-6 col-lg-offset-3">
    <div class="panel">
        ...
        <!--Horizontal Form-->
        <!--===================================================-->
        <form class="form-horizontal" action="{{ route('menu.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" placeholder="{{__('Order number')}}" id="sort" name="sort" value="{{ $category->sort }}" class="form-control">
                    </div>
                </div>
