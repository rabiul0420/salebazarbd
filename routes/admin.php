...
Route::post('/notice/send', 'NoticeController@send')->name('notices.send');
	...
	Route::post('/reviews/{id}/update', 'ReviewController@update')->name('reviews.update');
	Route::get('/reviews/destroy/{review}', 'ReviewController@destroy')->name('reviews.delete');
	...
	Route::post('/shop/hide_banner', 'ShopController@hideBanner')->name('shop.hide_banner');
