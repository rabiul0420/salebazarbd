...
Route::post('/users/login', '\App\Http\Controllers\Auth\LoginController@login')->name('user.login.submit');
// Route::post('/users/login', 'HomeController@user_login')->name('user.login.submit');

Route::get('/users/registration', 'HomeController@registration')->name('user.registration');
Route::post('/users/register', 'HomeController@user_registration')->name('user.register');
...
Route::post('/checkout/success', 'CheckoutController@success')->name('success');
...
Route::group(['middleware' => ['auth']], function(){
	...
	Route::post('/orders/cancel-order', 'OrderController@sellerCancelOrder')->name('orders.cancelOrder');
