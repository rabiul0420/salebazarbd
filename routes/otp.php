...
Route::post('/phone/code/resend', 'OTPLoginController@resend_verificcation_code')->name('phone.code.resend');
Route::post('/login/verification', 'HomeController@verify_login')->name('login.verification.submit');
Route::post('/cart/verification', 'HomeController@verify_login_cart')->name('cart.verification.submit');
...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::post('/sms-send-test', 'SmsController@sendtest')->name('sms.send.test');
});
